...
checkpoint = ModelCheckpoint('../SCRIPTS/TDL/PHYCUV/MODELS/AUGMENTED/Resnet50/Resnet50_Reg_L2_Lr_00001.h5', monitor='val_loss', save_best_only=True, mode='min', verbose=1)
